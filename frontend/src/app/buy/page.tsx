...
import { 
  MapPin, Building, Home, Star, Filter
} from 'lucide-react';
...
const TYPE_COLORS: Record<string, string> = {
  ...
  plot: '#f97316',
  penthouse: 'var(--accent-purple, #8b5cf6)',
  duplex: '#ec4899',
  rowhouse: '#eab308',
  studio: '#14b8a6'
};
...
export default function BuyPage() {
  ...
  }, [city, propertyType, bhk, minPrice, maxPrice, sortBy]);
    ...
    <div style={{ minHeight: '100vh', backgroundColor: 'var(--bg-light, #f8fafc)' }}>
        ...
        <div style={{ maxWidth: '1400px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: '16px', flexWrap: 'wrap', alignItems: 'center' }}>
            ...
            <input 
              ...
              style={{ padding: '10px 16px', borderRadius: '8px', border: '1px solid var(--border-light, #e2e8f0)', outline: 'none', backgroundColor: 'var(--bg-light)', width: '140px' }} 
            />
      ...
      <div style={{ maxWidth: '1400px', margin: '0 auto', padding: '32px' }}>
        <h2 style={{ fontSize: '20px', fontWeight: 600, color: 'var(--text-dark, #0f172a)', marginBottom: '24px' }}>
          {filteredProperties.length} Properties available for sale
        </h2>
            ...
            <Link key={property.id} href={`/properties/${property.id}`} style={{ textDecoration: 'none' }}>
              ...
              >
                ...
                <div style={{ padding: '20px', flex: 1, display: 'flex', flexDirection: 'column' }}>
                  ...
                  <div style={{ fontSize: '13px', color: 'var(--text-muted-dark, #64748b)', marginBottom: '20px' }}>
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px', padding: '12px 0', borderTop: '1px solid var(--border-light, #e2e8f0)', borderBottom: '1px solid var(--border-light, #e2e8f0)', marginTop: 'auto', marginBottom: '16px' }}>
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                      ...
                      <div>
                        ...
                        <div style={{ fontSize: '14px', fontWeight: 600, color: 'var(--text-dark)' }}>{property.possession}</div>
                      </div>
                    </div>
                  </div>
                  
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                    <div style={{ fontSize: '13px', color: 'var(--text-muted-dark)' }}>By {property.builder}</div>
                    <div style={{ color: 'var(--accent-blue, #3b82f6)', fontSize: '14px', fontWeight: 600 }}>View Details →</div>
                  </div>
                </div>
              </div>
            </Link>
